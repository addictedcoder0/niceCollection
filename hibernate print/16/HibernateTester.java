...
import org.rudra.modelClass16.UserDetails;
import org.rudra.modelClass16.Vehicle;
...
public class HibernateTester {
	...
	public static void main(String[] args) {
		...
		vehicle1 = session.get(Vehicle.class,userDetails.getVehicle().iterator().next().getVehicleId());
		...
		System.out.println("vehicle details : "+vehicle1.getVehicleId());
		System.out.println("vehicle details : "+vehicle1.getVehicleName());
		session.close();
