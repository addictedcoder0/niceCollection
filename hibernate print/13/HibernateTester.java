...
import org.rudra.modelClass13.Address;
import org.rudra.modelClass13.UserDetails;
import org.rudra.modelClass13.UserId;
...
public class HibernateTester {
	...
	public static void main(String[] args) {
		...
		session.close(); //to test the Eager initialization close the session , before making call to collection
