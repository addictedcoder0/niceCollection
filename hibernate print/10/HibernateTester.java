...
import org.rudra.modelClass10.Address;
import org.rudra.modelClass10.UserDetails;
import org.rudra.modelClass10.UserId;
...
public class HibernateTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(storedUser_info.getListOfAddress().get(0).getState());
		System.out.println(storedUser_info.getListOfAddress().get(0).getStreet());
		System.out.println(storedUser_info.getListOfAddress().get(0).getCity());
